...
New-AzureRmResourceGroupDeployment -ResourceGroupName "lab8" -TemplateFile ".\FullDeploy.json" -TemplateParameterFile ".\azuredeploy.parameters.json" -deploymentNumber 7 -adfsImageSKU "2008-R2-SP1" -Verbose
